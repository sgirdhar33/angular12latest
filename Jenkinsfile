  ...
  stages {
    ...
    stage ('Install') {
      steps {
        ...
        bat 'npm install --registry=http://20.121.10.70:8081/repository/npm-registry1/'
        bat 'npm install replace-in-file --save-dev --registry=http://20.121.10.70:8081/repository/npm-registry1/'
        bat 'npm install -g @angular/cli --registry=http://20.121.10.70:8081/repository/npm-registry1/'
      }
    }
