...
pipeline {
  ...
  stages {
    ...
    stage ('Deploy') {
      steps {
        bat '"C:\\Program Files\\git\\usr\\bin\\scp.exe" -i "C:\\Users\\Saurav\\.ssh\\id_rsa" C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\Angular12\\dist\\angular12\\** Saurav@40.71.189.81:/usr'
